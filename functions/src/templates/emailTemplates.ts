...
export type TemplateData = WelcomeRegistrationData | PasswordResetData | Record<string, any>;

/**
 * Get email content based on template type
 * 
 * @param type - The template type (e.g., 'welcome_registration', 'password_reset')
